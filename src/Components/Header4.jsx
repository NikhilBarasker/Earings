...
//             <div className="left-10 absolute z-50 bg-gray-100 flex px-4 py-3 rounded max-lg:hidden" style={isFocused ? {border: '1px solid gray'} : {border:'1px solid transparent'}}>
//               <svg
...
export default function Header4() {
  ...
  onClick={toogleLog}
  onBlur={toogleLog}
    class="px-6 py-2 flex items-center rounded-full text-[#333] text-sm font-semibold border-2 border-gray-300 outline-none hover:bg-gray-100">
    {/* <img src="https://readymadeui.com/profile_6.webp" class="w-7 h-7 mr-2 rounded-full shrink-0"></img> */}
  ...
  {show && <ul class='absolute shadow-lg bg-white py-2 z-[1000] min-w-full w-max rounded-lg max-h-96 overflow-auto'>
