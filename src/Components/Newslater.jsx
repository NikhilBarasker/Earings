...
const Newslater = () => {
  return (
    <div>
      ...
      <div class="max-w-7xl mx-auto py-16 px-6 relative" style={{background:'rgb(185,141,88)', backgroundColor:'linear-gradient(180deg, rgba(185,141,88,0.8968837535014006) 0%, rgba(185,141,88,0.7484243697478992) 93%)'}}>
        <div class="max-w-2xl mx-auto text-center">
          ...
          <div
            ...
            <button
              class="bg-[#333] hover:bg-[#111] text-white flex items-center transition-all font-semibold px-5 py-4" style={{background:'#b98d58'}}>
              Subscribe
            </button>
          </div>
        </div>
